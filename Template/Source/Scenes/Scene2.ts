namespace Template {
    ...
    await ƒS.Character.hide(characters.bonny);
    await ƒS.Character.show(characters.bonny, characters.bonny.pose.shocked, ƒS.positionPercent(30, 110));
    await ƒS.update(0.25);
    ...
    await ƒS.Character.animate(characters.bonny, characters.bonny.pose.happy, fade()); 
    await ƒS.update();
